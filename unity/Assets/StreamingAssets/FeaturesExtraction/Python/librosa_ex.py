...
def onset_detection(path):
    ...
    # Obtener directorio sin el nombre del archivo
...
def features_to_txt(path):
    # Carga la canción en un array de muestras
    samples, sr = load_Wave(path) #mono=True
...
# Path: ruta donde se encuentra la canción
# Filename: nombre+extensión de la canción
def main(path):
