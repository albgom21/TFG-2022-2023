...
public class ObstacleGenerator : MonoBehaviour
{
    ...
    {
        obstaclesStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/Defaults");
        lowZoneStartStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/ChangeZone/LowZoneStart");
        lowZoneEndStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/ChangeZone/LowZoneEnd");
        highZoneStartStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/ChangeZone/HighZoneStart");
        highZoneEndStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/ChangeZone/HighZoneEnd");
        gravityStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/PowerUps/Gravity");
        slowMotionStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/PowerUps/SlowMotion");
        lowResStructures = Resources.LoadAll<GameObject>("Prefabs/Structs/PowerUps/LowRes");
    }
